...
CATALOG: dict[str, str] = {
    ...
    "작성자": "Author",
    "날짜": "Date",
    "이 파일의 히스토리": "History of this file",
    "기록을 읽는 중…": "Reading history…",
    "이름이 바뀐 파일은 바뀐 시점까지만 보입니다.": "A renamed file shows history only back to the rename.",
    "이 경로를 바꾼 커밋이 없습니다.": "No commit has changed this path.",
    "파일 히스토리 — {path}": "File history — {path}",
    "커밋 {count}개": "{count} commits",
    "읽지 못했습니다: {message}": "Could not read: {message}",
    "파일 히스토리를 읽는 중 예상치 못한 오류가 발생했습니다.": "Unexpected error while reading the file history.",
